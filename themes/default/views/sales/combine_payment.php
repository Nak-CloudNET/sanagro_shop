                        ...
                        foreach ($combine_sales as $combine_sale) { ?>
                            <tr class="row<?= $combine_sale->id ?>">
                                ...
                                <td class="col-xs-3">
									...
									<input type="hidden" name="combine_payment" class="form-control" value="<?= isset($combine_payment); ?>" id="combine_payment">
									<input type="hidden" name="customer_balance" class="form-control" value="<?= isset($customer_balance); ?>" id="customer_balance">
									<input type="hidden" name="receivable" class="form-control" value="<?= isset($receivable); ?>" id="receivable">
									<input type="hidden" name="sale_id[]" class="form-control" value="<?= isset($combine_sale->id); ?>" id="amount_">
