                        ...
                        <div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input name="amount_paid_kh" type="text" id="amount_kh_1" amount="<?= ($inv->grand_total - $inv->paid) * $inv->other_cur_paid_rate ?>"
										   value="<?= ($inv->grand_total - $inv->paid) * $inv->other_cur_paid_rate ?>"
...
<script type="text/javascript" charset="UTF-8">
    $(document).ready(function () {
		...
		$('#amount_kh_1').keyup(function () {
			...
			var amount_kh 	= parseFloat($('#amount_kh_1').attr('amount')-0);
			...
			if(!kh_paid) {
				...
				$('#amount_1').val(0);
				$('#amount_kh_1').select();
			}else if(kh_paid > amount_kh) {
				$('#amount_kh_1').val(amount_kh);
				$('#amount_1').val(formatDecimal(amount_kh/cur_kh_rate));
				$('#amount_kh_1').select();
			}else{
