                ...
                <div class="table-scroll">
                    <table  cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped table-condensed">
						...
						?>
							...
							?>
								<td class="right">
									<b><?php echo number_format(abs($total_liability),2);?></b>
								</td>
							</tr>
							<tr class="primary">
								<th colspan="<?=$num_col?>">
						...
						<?php
							...
							$total_retained = (-1)*$total_income - $total_expense;
						?>
							<tr>
							<td>
							...
							for($c= 0; $c < count($new_billers); $c++){
								...
								$total_per_retained = (-1)*$r_inc_per - $r_exp_per;
								$total_retained_arr[] = array(
									'biller_id' => $in_bill_id1,
						...
						<?php
							...
							?>
									...
									<td class="right">
										<?php echo number_format(abs($totalBeforeAyearRows->amount),2);?>
									</td>
							<?php
									}else{
										$total_eq_arr[] = array(
						...
						?>							
							...
							for($c= 0; $c < count($new_billers); $c++){
								...
								echo '<td class="right"><b>'. $total_eq_amt .'</b></td>';
							}
							...
							<tr>
								...
								?>								
								<td class="right"><b><?php echo number_format(abs($end_total_lib) + $end_total_eq,2);?></b></td>								
							</tr>							
                        </tbody>
                    </table>
                </div>
