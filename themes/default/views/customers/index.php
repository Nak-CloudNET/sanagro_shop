    ...
    $(document).ready(function () {
        ...
        var cTable = $('#CusData').dataTable({
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": center}, ((site.settings.show_company_code== 1)? null:{"bVisible": false}), null, null, null, null, null, null,null, null, {
                "bSortable": false,
                "mRender": attachment
            }, {"bSortable": false}]
        }).dtFilter([
            ...
            {column_number: 9, filter_default_label: "[<?=lang('price_groups');?>]", filter_type: "text", data: []},
