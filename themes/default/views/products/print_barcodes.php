            ...
            <div class="col-lg-12">
                ...
                <div class="well well-sm no-print">
                    ...
                    <div class="controls table-controls">
                        ...
                        <div class="form-group">
                            <?= lang('style', 'style'); ?>
                            <?php $opts = array('' => lang('select').' '.lang('style'),11 => lang('SWAP'), 10 => lang('AYCollection'),40 => lang('40_per_sheet'), 30 => lang('30_per_sheet'), 24 => lang('24_per_sheet'), 20 => lang('20_per_sheet'), 18 => lang('18_per_sheet'), 14 => lang('14_per_sheet'), 12 => lang('12_per_sheet'),  50 => lang('continuous_feed'), 16=>lang('new')); ?>
                            ...
                            if (!empty($barcodes)) {
                                ...
                                foreach ($barcodes as $item) {
                                    for ($r = 1; $r <= $item['quantity']; $r++) {
                                        ...
                                        if($item['price']) {
                                            echo '<span class="barcode_price" style="margin-top:-3px;font-weight:bold; font-size:10px; display:block; padding-top:2 !important;margin-bottom:9px;">'.lang('$').' ';
                                            if($item['currencies']) {
