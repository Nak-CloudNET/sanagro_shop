...
<script>
    $(document).ready(function () {
		...
		"aoColumns": [{"bSortable": false, "mRender": checkbox},{"mRender": fld},null,null,null,null,null,{"mRender":row_statusX},{"bSortable": false}],
...
<div class="box">
    <div class="box-header">
		...
		<!-- <h2 class="blue"><i	class="fa-fw fa fa-heart"></i><?=lang('list_using_stock') . ' (' . ($warehouse->id ? $warehouse->name : lang('all_warehouses')) . ')';?></h2> -->
		<h2 class="blue">
