    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <!-- <div class="row"> -->
                ...
                <!-- </div> -->
                <div class="col-sm-12 col-xs-12 text-center"><h4><b><?= strtoupper(lang("stock_using_issue_form")); ?></b></h4></div>
            <!-- </div> --><br><br><br>
                    ...
                    <tbody style="font-size: 13px;">
                        ...
                        $total = 0;
                            ...
                            echo'
                                    ...
                                    <tr>
                                ';
                            // <td style="text-align:center;">'. ($si->option_id ? $si->cost * $si->variant_qty : $si->cost) .'</td>
                                        // <td style="text-align:right;">'.$this->erp->formatMoney($si->qty_use*$si->cost).'</td>
                        ?>
                            <!-- <tr>
                                <td colspan="4"><span><b>Note : </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo strip_tags($using_stock->note); ?></span></td>
