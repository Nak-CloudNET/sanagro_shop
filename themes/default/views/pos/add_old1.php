        ...
        <div class="container bblack" id="container">
            ...
            <div class="header-nav">
                ...
                <ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown">
                        <a class="btn pos-tip" title="<?= lang('delivery') ?>" data-placement="bottom" href="<?= site_url('pos/add_deliveries') ?>" data-toggle="modal" data-target="#myModal">
                                ...
                                <div id="botbuttons" style="text-align:center;">
                                    ...
                                    <div class="btn-group btn-group-justified">
                    					...
                    					<div class="btn-group">
                                        	<div class="btn-group btn-group-justified">
                                           		<div class="btn-group">                                                    											    	
													<button type="button" title="Table / Room - <?= $pos_settings->suspend_sale ?>" style="height:68px;" class="btn btn-warning open-suspend" id="suspend">
                                        ...
                                        <div class="btn-group">
                                            <div class="btn-group btn-group-justified">
                                                <div class="btn-group">
                                                    <button type="button" title="Print Order - <?= $pos_settings->print_items_list ?>" style="height:68px;" class="btn btn-primary" id="print_order">
                    					...
                    					<div class="btn-group">
                                            <div class="btn-group btn-group-justified">
                                                <div class="btn-group">
                                                    <button type="button" title="Print Order - <?= $pos_settings->print_items_list ?>" class="btn btn-primary" id="print_order">
                                                        <i class="fa fa-print"></i> <?= lang('print_order'); ?>
                                                    </button>
