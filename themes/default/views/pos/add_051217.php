...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        <?php if($sale_order_id || $delivery_id) { ?>
		...
		localStorage.setItem('group_area', '<?= $sale_order->group_areas_id ?>');
		...
		<?php if($sale_order->payment_status == 'partial' || $sale_order->payment_status == 'paid') { ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<div class="col-md-4" id="so_ref" style="display:none;">
							<div class="form-group">
								<?= lang("so_no", "soref"); ?>
								<?php echo form_input('so_reference_no', '', 'class="form-control input-tip" id="soref" style="pointer-events:none;"'); ?>
									...
									<div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php if ($Owner || $Admin || $GP['customers-add']) { ?><div class="input-group"><?php } ?>
                                                <?php
                                                echo form_input('customer_1', (isset($_POST['customer']) ? $_POST['customer'] : ($sale_order->company_name?$sale_order->company_name:"")), 'id="slcustomer" data-placeholder="' . lang("select") . ' ' . lang("customer") . '" required="required" class="form-control input-tip" style="min-width:100%;"');
                                                ?>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="payment">
                                                    <div class="form-group ngc">
                                                        ...
                                                        <input name="amount-paid" value="" type="text" id="amount_1" class="pa form-control kb-pad amount"/>
                                                    </div>
