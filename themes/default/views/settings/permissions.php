								...
								<tr>
                                    ...
                                    <td colspan="7">
									    <div class="container-fluid" style="padding-left:30px;">
											...
											<input type="checkbox" value="1" id="settings-customer_groups" class="checkbox"
													name="settings-customer_groups" <?php echo $p->{'settings-customer_groups'} ? "checked" : ''; ?>><label
												for="settings-customer_groups" class="padding05"><?= lang('customer_groups') ?></label>
											<input type="checkbox" value="1" id="settings-categories" class="checkbox"
													name="settings-categories" <?php echo $p->{'settings-categories'} ? "checked" : ''; ?>><label
												for="settings-categories" class="padding05"><?= lang('categories') ?></label>
											<input type="checkbox" value="1" id="settings-price_groups" class="checkbox"
													name="settings-price_groups" <?php echo $p->{'settings-price_groups'} ? "checked" : ''; ?>><label
												for="settings-price_groups" class="padding05"><?= lang('price_groups') ?></label>
											<input type="checkbox" value="1" id="settings-units" class="checkbox"
													name="settings-units" <?php echo $p->{'settings-units'} ? "checked" : ''; ?>><label
												for="settings-units" class="padding05"><?= lang('units') ?></label>
											<input type="checkbox" value="1" id="settings-bom" class="checkbox"
													name="settings-bom" <?php echo $p->{'settings-bom'} ? "checked" : ''; ?>><label
												for="settings-bom" class="padding05"><?= lang('bom') ?></label>
											<input type="checkbox" value="1" id="settings-payment_term" class="checkbox"
													name="settings-payment_term" <?php echo $p->{'settings-payment_term'} ? "checked" : ''; ?>><label
												for="settings-payment_term" class="padding05"><?= lang('payment_term') ?></label>
										</div>		
                                    </td>
                                </tr>
							<!--	<tr>
