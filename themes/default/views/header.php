																		...
																		<?php if ($Owner || $Admin || $GP['sale_order-add']) { ?>
																			<li>
																				<?php																				
																					$sale_order_id = array();
																					$alert_num = 0;
																					foreach($sale_order_alert_num as $sale_order){
																						$alert_num += $sale_order->alert_num;
																						$sale_order_id[] = $sale_order->sale_order_id;
																					}
																					$sale_order_id = implode("_", $sale_order_id);
																				?>
																				<a href="<?= site_url('sale_order/list_sale_order/?id=' . $sale_order_id) ?>" class="">
																				...
																				<input type = "hidden" name ="ref_sale_order" value="<?= $reference_no; ?>">
																			</li>
																		<?php } ?>
                                                                        <!-- Delivery Alert -->
                                                                        <!-- <li>
																			<a href="<?= isset($delivery_alert_num)?site_url('sales/deliveries_alerts/'.date('Y-m-d', strtotime($delivery_alert_num->date))):""; ?>" class="">
																				<span class="label label-danger pull-right" style="margin-top:3px;"><?= isset($delivery_alert_num)?$delivery_alert_num->alert_num:""; ?></span>
																		...
																		<?php if ($Owner || $Admin || $GP['sales-add_delivery']) { ?>
																			<li>
																				<?php																				
																					$sale_order_id = array();
																					$alert_num = 0;
																					foreach($delivery_alert_num as $sale_order){
																						$alert_num += $sale_order->alert_num;
																						$sale_order_id[] = $sale_order->sale_order_id;
																					}
																					$sale_order_id = implode("_", $sale_order_id);
																				?>
																				<a href="<?= site_url('sales/add_deliveries/?id=' . $sale_order_id) ?>" class="">
																					<span class="label label-danger pull-right" style="margin-top:3px;"><?= $alert_num; ?></span>
																					<span style="padding-right: 35px;"><?= lang('deliveries_alerts') ?></span>
																				</a>
																			</li>
																		...
																		<?php if ($Owner || $Admin || $GP['sales-add']) { ?>
																			<li>
																				<?php																				
																					$delivery_id = array();
																					$alert_num = 0;
																					foreach($sale_alert_num as $sale_alert){
																						$alert_num += $sale_alert->alert_num;
																						$delivery_id[] = $sale_alert->delivery_id;
																					}
																					$delivery_id = implode("_", $delivery_id);
																				?>
																				<a href="<?= site_url('sales/deliveries/?id=' . $delivery_id) ?>" class="">
																					<span class="label label-danger pull-right" style="margin-top:3px;"><?= $alert_num; ?></span>
																					<span style="padding-right: 35px;"><?= lang('sale_alerts') ?></span>
																				</a>
																			</li>
                                                                        <?php } ?>
                                                                        <!-- Customer Alert -->
                    ...
                    <div class="sidebar-nav nav-collapse collapse navbar-collapse" id="sidebar_menu">
                                               ...
                                               <li id="employees_index">
												...
												<li id="employees_create_employee_salary">
													<a class="submenu" href="<?= site_url('employees/create_employee_salary'); ?>" >
														<i class="fa fa-money"></i><span class="text"> <?= lang('create_employee_salary'); ?></span>
													</a>
												</li>
												-->
									</ul>
											...
											<ul> 
                                                                ...
                                                                <li id="reports_daily_sales">
                                                                    <a href="<?= site_url('reports/daily_sales') ?>">
                                                                        <i class="fa fa-heart"></i><span class="text"> <?= lang('daily_sales'); ?></span>
                                                                    </a>
                                                                </li>
                                                                <li id="reports_monthly_sales">
                                                                    <a href="<?= site_url('reports/monthly_sales') ?>">
                                                                        <i class="fa fa-heart"></i><span class="text"> <?= lang('monthly_sales'); ?></span>
                                                                    </a>
                                                                </li>
																<li id="reports_sales_discount">
																	<a href="<?= site_url('reports/sales_discount') ?>">
																		<i class="fa fa-heart"></i><span class="text"> <?= lang('sales_discount_report'); ?></span>
																	</a>
																</li>                                                                
                        ...
                        <?php } else { ?>
                                            <?php if ($GP['products-index']) { ?>
												...
												<?php if ($GP['sales-index'] || $GP['sale_order-index'] || $GP['sales-deliveries'] || $GP['sales-add_delivery']) { ?>
													<li class="mm_sales mm_sale_order mm_deliveries <?= strtolower($this->router->fetch_method()) == 'settings' ? '' : 'mm_pos' ?>">
														<a class="dropmenu" href="#">
															<i class="fa fa-heart"></i>
															<span class="text"> <?= lang('manage_sales'); ?> 
															</span> <span class="chevron closed"></span>
												...
												<?php if ($GP['purchases-index'] || $GP['purchases_order-index']) { ?>
													<li class="mm_purchases mm_purchase_order">
														<a class="dropmenu" href="#">
															<i class="fa fa-star"></i>
															<span class="text"> <?= lang('manage_purchases'); ?> 
															</span> <span class="chevron closed"></span>
									...
									<?php  if($GP['settings-currencies'] || $GP['settings-customer_groups'] || $GP['settings-categories'] || $GP['settings-price_groups'] || $GP['settings-units'] || $GP['settings-bom'] || $GP['settings-payment_term']) { ?>
										<li class="mm_system_settings <?= strtolower($this->router->fetch_method()) != 'settings' ? '' : 'mm_pos' ?>">
											...
											<ul>
													...
													<?php if($GP['settings-customer_groups']) { ?>
														<li id="system_settings_customer_groups">
															<a href="<?= site_url('system_settings/customer_groups') ?>">
																<i class="fa fa-chain"></i><span class="text"> <?= lang('customer_groups'); ?></span>
															</a>
													...
													<?php if($GP['settings-price_groups']) { ?>
														<li id="system_settings_price_groups">
															<a href="<?= site_url('system_settings/price_groups') ?>">
																<i class="fa fa-dollar"></i><span class="text"> <?= lang('price_groups'); ?></span>
															</a>
													...
													<?php if($GP['settings-payment_term']) { ?>
														<li id="system_settings_payment_term">
															<a href="<?= site_url('system_settings/payment_term') ?>">
																<i class="fa fa-money"></i><span class="text"> <?= lang('payment_term'); ?></span>
															</a>
											...
											<li class="mm_chart_report">
												...
												<ul>
													...
													<?php if($GP['chart_report-warehouse_stock']){ ?>
														<li id="chart_report-warehouse_stock">
															<a href="<?= site_url('reports/warehouse_stock') ?>">
											...
											<li class="mm_product_report">
												...
												<ul>
													...
													<?php if($GP['sale_report-detail']){ ?>
														<li id="reports_sales_detail">
															<a href="<?= site_url('reports/sales_detail') ?>">
																<i class="fa fa-money"></i><span class="text"> <?= lang('sales_detail_report'); ?></span>
															</a>
														</li>
													<?php } ?>
