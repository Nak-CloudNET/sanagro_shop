                    ...
                    <?php if (!empty($combine_sales)) {
                        ...
                        foreach ($combine_sales as $combine_sale) { ?>
                            <tr class="row<?= $combine_sale->id ?>">
								...
								<td class="col-xs-3">
								    <input type="hidden" name="payable" class="form-control" value="<?= isset($payable); ?>" id="payable">
								    <input type="hidden" name="supplier_balance" class="form-control" value="<?= isset($supplier_balance); ?>" id="supplier_balance">
