...
$(document).ready(function (e) {
	 ...
	 * Edit Row Method
	 ...
	 $(document).on('click', '#editItem', function () {
		...
		sloitems[item_id].row.real_unit_price 	= pgroup_price == 0 || pgroup_price == undefined ? price : price / opt_cur,
...
function loadItems() {
	if (localStorage.getItem('sloitems')) {
		...
		$.each(sloitems, function () {
			...
			var default_price 	= (item_price ? item_price : 0);
			...
			item_price = item_tax_method == '0' ? unit_price - pr_tax_val : formatDecimal(unit_price);
			
			iprice = item_tax_method == '0' ? formatDecimal(unit_price - pr_tax_val) : formatDecimal(unit_price);
