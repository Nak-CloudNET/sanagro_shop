...
class Customers extends MY_Controller
{
    ...
    function getCustomers()
    {
		...
		$this->datatables
            ->select("companies.id, companies.id as cid, COALESCE(code, '') AS code, company, companies.name, email, phone, group_areas.areas_group, customer_group_name, price_groups.name as price_group_name, award_points, attachment")
            ->from("companies")
