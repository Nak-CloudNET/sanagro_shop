...
class Sale_order extends MY_Controller
{
                ...
                if (isset($item_code) && isset($real_unit_price) && isset($unit_price) && isset($item_quantity)) {
                    ...
                    if (isset($item_discount)) {
                        ...
                        if ($dpos !== false) {
                            ...
                            $pr_discount = (($this->erp->formatDecimal($unit_price * $item_quantity)) * ((Float) ($pds[0]) / 100));
					...
					$cur_rate = $this->sale_order_model->getExchange_rate();
                    ...
                    $subtotal = (($item_net_price * $item_quantity) + $item_tax *$item_quantity - $pr_discount);
            ...
            if ($this->Settings->tax2) {
                ...
                if ($order_tax_details = $this->site->getTaxRateByID($order_tax_id)) {
                    ...
                    if ($order_tax_details->type == 2) {
						if ($opos !== false) {							
							$ods = explode("%", $order_discount_id);
							$total_no_tax = ($total - ($total * ($ods[0]/100))) + $shipping;
	...
	function getSaleOrder($warehouse_id = NULL)
    {
		...
		$unapproved = anchor('sale_order/getunapproved/$1', '<i class="fa fa-check"></i> ' . lang('unapproved'), '');
		$rejected = anchor('sale_order/getrejected/$1', '<i class="fa fa-times"></i> ' . lang('rejected'), '');
        $delete_link = "<a href='#' class='po' title='<b>" . lang("delete_sale") . "</b>' data-content=\"<p>"
            . lang('r_u_sure') . "</p><a class='btn btn-danger' href='" . site_url('sale_order/deleteSaleOrder/$1') . "'>"
