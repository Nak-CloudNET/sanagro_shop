        ...
        if (!empty($_POST['val'])) {
            if ($this->input->post('form_action') == 'export_excel' || $this->input->post('form_action') == 'export_pdf') {
                ...
                foreach ($_POST['val'] as $id) { 
                    ...
                    $this->excel->getActiveSheet()->SetCellValue('D' . $row, $adjust->created_by);
	...
	*/
    ...
    { 
        ...
        if ($this->form_validation->run() == true) {
			...
			foreach($convert_from as $comItem){
				...
				$this->products_model->delete_inventory_valuation_by_cont_items($comItem->id);
		...
		$warehouse =  $this->products_model->getConvertByID($id); 
		$this->data['convert_items'] 	= $this->products_model->getConvert_ItemByID($id,$warehouse->warehouse_id);
	...
	function add_count_stock($page = NULL)
    {
        ...
        if ($this->form_validation->run() == true && $this->products_model->addStockCount($data)) {
            ...
            $this->data['categories'] 	= $this->site->getAllCategories();
            $this->data['brands'] 		= $this->site->getAllBrands();
			$this->data['reference'] 	= $this->site->getReference('st', $this->default_biller_id);
