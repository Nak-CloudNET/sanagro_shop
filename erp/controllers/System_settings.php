...
class system_settings extends MY_Controller
{
    ...
    function index()
    {
        $this->erp->checkPermissions('setting','','system');
        ...
        $this->form_validation->set_rules('project_code_prefix', lang('project_code_prefix'), 'trim');
        $this->form_validation->set_rules('customer_code_prefix', lang('customer_code_prefix'), 'trim');
        $this->form_validation->set_rules('supplier_code_prefix', lang('supplier_code_prefix'), 'trim');
        $this->form_validation->set_rules('employee_code_prefix', lang('employee_code_prefix'), 'trim');
	...
	function payment_term()
    {
		...
		$this->erp->checkPermissions('payment_term', true, 'settings');
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array(
				...
				*/
				...
				'settings-price_groups' 	=> $this->input->post('settings-price_groups'),
				'settings-units' 			=> $this->input->post('settings-units'),
				'settings-bom' 				=> $this->input->post('settings-bom'),
				'settings-payment_term' 	=> $this->input->post('settings-payment_term')
            );
    ...
    function currencies()
    {
		$this->erp->checkPermissions('currencies', true, 'settings');
		$this->data['error'] = validation_errors() ? validation_errors() : $this->session->flashdata('error');
    ...
    {
		$this->erp->checkPermissions('categories', true, 'settings');
        $this->data['error'] = validation_errors() ? validation_errors() : $this->session->flashdata('error');
    ...
    {
		$this->erp->checkPermissions('customer_groups', true, 'settings');
        $this->data['error'] = validation_errors() ? validation_errors() : $this->session->flashdata('error');
    ...
    function add_customer_group()
    {
        ...
        if ($this->form_validation->run() == true) {
			...
			{
				$categories[]=array('cate_id'=>$cate_id[$i],'percent'=>$percent[$i]);
			}
    ...
    function edit_customer_group($id = NULL)
    {
        ...
        if ($this->form_validation->run() == true && $this->settings_model->updateCustomerGroup($id, $data,$categories)) {
			...
			//$this->erp->print_arrays($this->settings_model->Old_Customer_Group($id));
	...
	function bom(){
		...
		$this->erp->checkPermissions('bom', true, 'settings');
    ...
    function units()
    {
		$this->erp->checkPermissions('units', true, 'settings');
        $this->data['error'] = validation_errors() ? validation_errors() : $this->session->flashdata('error');
    ...
    {
		$this->erp->checkPermissions('price_groups', true, 'settings');
        $this->data['error'] = validation_errors() ? validation_errors() : $this->session->flashdata('error');
