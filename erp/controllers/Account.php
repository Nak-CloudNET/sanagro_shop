...
class Account extends MY_Controller
{
  ...
  //       }
	...
	function getJournalList()
	{
		...
		//->join('deposits','deposits.id = gt.tran_id','left')
	...
	function getCustomerInvoices($customer = null){
	...
	function receivable_actions($wh=null)
	{
		if($wh){
			$wh = explode('-', $wh);
		}
	...
	function payable_actions($wh=null)
	{
		if($wh){
			$wh = explode('-', $wh);
		}
