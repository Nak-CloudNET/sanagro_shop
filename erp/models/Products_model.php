...
class Products_model extends CI_Model
{
	...
	public function getConvertByID($id) {
        ...
        $this->db
            ->select($this->db->dbprefix('convert') . ".id as id,
					...
					".$this->db->dbprefix('convert').".biller_id,
					".$this->db->dbprefix('convert').".bom_id,
	...
	public function getConvert_ItemByID($id,$warehouse_id)
    {
    ...
    */
	...
	public function delete_purchase_items_by_conId($id){
		$this->db->where(array('transaction_id' => $id, 'transaction_type' => 'CONVERT'));
		$d=$this->db->delete('purchase_items');
		if($d){
			return true;
		}return false;
	...
	public function delete_inventory_valuation_by_cont_items($con_item_id){
		$d = $this->db->delete('inventory_valuation_details', array('field_id' => $con_item_id, 'type' => 'CONVERT'));
	}
